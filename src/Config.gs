...
const CONFIG = {
  ...
  SAFETY: {
    ...
    SAFE_DOMAINS: [
      ...
      // --- Small Finance & Co-operative Banks ---
      'suryodaybank.com',
      'esafbank.com',
      'utkarshbank.com',
      'jana.bank',
      ...
      'lichousing.com',
      'muthootfincorp.com',
      'manappuramfinance.com',
      'cholafin.com',     // Chola Mandalam
      'shriramfinance.in',
      'mahindrafinance.com',
      'tvscredit.com',
      'l-t.com',          // L&T Finance
      'ltfs.com',
      'indiabullshomeloan.com',
      'piramalfinance.com',
      'fullerton.co.in',

      // --- Mutual Funds (AMCs) ---
      'camsonline.com',   // CAMS registrar
      'kfintech.com',     // KFin registrar
      'sbimf.com',
      'hdfcfund.com',
      'icicipruamc.com',
      'axismf.com',
